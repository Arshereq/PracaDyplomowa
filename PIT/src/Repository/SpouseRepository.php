...
/**
 * @extends ServiceEntityRepository<Spouse>
 *
...
class SpouseRepository extends ServiceEntityRepository
{
    ...
    public function save(Spouse $entity, bool $flush = false): void
    {
    ...
    public function remove(Spouse $entity, bool $flush = false): void
    {
